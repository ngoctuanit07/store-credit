...
if (Mage::helper('aw_storecredit')->extensionEnabled('AW_Customsmtp')) {
    class AW_Storecredit_Model_Email_TemplateCommon extends AW_Customsmtp_Model_Email_Template
    {
    }
} else {
    class AW_Storecredit_Model_Email_TemplateCommon extends Mage_Core_Model_Email_Template
    {
    }
}

class AW_Storecredit_Model_Email_Template extends AW_Storecredit_Model_Email_TemplateCommon
{

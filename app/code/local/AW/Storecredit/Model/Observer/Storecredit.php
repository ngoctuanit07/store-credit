...
class AW_Storecredit_Model_Observer_Storecredit extends Mage_Core_Model_Abstract
{
    ...
    public function saveShippingMethodAfter(Varien_Event_Observer $observer)
    {
        ...
        if (array_key_exists('update_section', $body) && array_key_exists('html', $body['update_section'])) {
                ...
                $baseAwStorecreditAmountUsed = Mage::getSingleton('checkout/session')->getQuote()->getBaseAwStorecreditAmountUsed();
                $body['update_section']['html'] = '<script type="text/javascript">'
                        ...
                        .   'if (!storeCreditManager.isStorecreditSubstracted && !storeCreditManager.storecreditCheckbox.checked && '. $baseAwStorecreditAmountUsed .') {'
                        .       'storeCreditManager.isStorecreditSubstracted = true;'
                        .   '}'
                        .   'storeCreditManager.baseStorecreditAmountUsed = '. $baseAwStorecreditAmountUsed . ';'
                        . '}</script>'
